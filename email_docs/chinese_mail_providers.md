...
- **Best free entry point:** **Alibaba Cloud DirectMail** (2,000-email lifetime free quota) and **Tencent Cloud SES** (1,000 free emails), then **SendCloud** (50–100 emails/day free). *(Alibaba **Enterprise** Mail has no free tier — it is a paid per-seat product from ~$2.87/user/month, 3-seat minimum; use DirectMail for Alibaba's free quota.)*
